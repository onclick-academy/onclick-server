...
export class SubCategoryController {
    ...
    static getAllSubCategories = async (req: Request, res: Response) => {
        ...
        try {
            ...
            return res.status(200).json({ message: 'All SubCategories retreived successfully', data: subCategories, status: 'success' })
        } catch (error: any) {
            return res.status(400).json({ error: error.message, status: 'failed' })
        }
    }
    ...
    static getSubCategoryById = async (req: Request, res: Response) => {
        ...
        try {
            ...
            return res.status(200).json({ message: 'SubCategory retreived successfully', data: subCategory, status: 'success' })
        } catch (error: any) {
            return res.status(400).json({ error: error.message, status: 'failed' })
        }
    }
    ...
    static updateSubCategory = async (req: Request, res: Response) => {
        ...
        try {
            ...
            return res.status(200).json({ message: 'SubCategory updated successfully', data: updatedSubCategory, status: 'success' })
        } catch (error: any) {
            return res.status(400).json({ error: error.message, status: 'failed' })
        }
    }
    ...
    static deleteSubCategory = async (req: Request, res: Response) => {
        ...
        try {
            ...
            return res.status(200).json({ message: 'SubCategory deleted successfully', data: deletedSubCategory, status: 'success' })
        } catch (error: any) {
            return res.status(400).json({ error: error.message, status: 'failed' })
        }
    }
