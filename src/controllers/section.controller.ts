...
export class SectionController {
    ...
    static updateSection = async (req: Request, res: Response) => {
        ...
        try {
            ...
            return res.status(200).json({ message: 'Section updated successfully', data: updatedSection, state: 'success' });
        } catch (error: any) {
            console.log(error);
            return res.status(500).json({ error: error.details[0].message });
        }
    ...
    static softDeleteSection = async (req: Request, res: Response) => {
        ...
        try {
            ...
            return res.status(200).json({ message: 'Section deleted (softly) successfully', data: deletedSection, state: 'success' });
        } catch (error: any) {
            console.log(error);
            return res.status(500).json({ error: error });
        }
    ...
    static hardDeleteSection = async (req: Request, res: Response) => {
        ...
        try {
            ...
            return res.status(200).json({ message: 'Section deleted successfully', data: deletedSection, state: 'success' });
        } catch (error: any) {
            console.log(error);
            return res.status(500).json({ error: error });
        }
