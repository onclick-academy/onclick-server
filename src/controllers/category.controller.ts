...
export class CategoryController {
    ...
    static getAllCategories = async (req: Request, res: Response) => {
        ...
        try {
            ...
            return res.status(200).json({ message: 'All Categories retreived successfully', data: categories, status: 'success' })
        } catch (error: any) {
            return res.status(400).json({ error: error.message, status: 'failed' })
        }
    }
    ...
    static getCategoryById = async (req: Request, res: Response) => {
        ...
        try {
            ...
            return res.status(200).json({ message: 'Category retreived successfully', data: category, status: 'success' })
        } catch (error: any) {
            return res.status(400).json({ error: error.message, status: 'failed' })
        }
    }
    ...
    static updateCategory = async (req: Request, res: Response) => {
        ...
        try {
            ...
            return res.status(201).json({ message: 'Category updated successfully', data: updatedCategory, status: 'success' })
        } catch (error: any) {
            return res.status(400).json({ error: error.message, status: 'failed' })
        }
    }
    ...
    static deleteCategory = async (req: Request, res: Response) => {
        ...
        try {
            ...
            return res.status(201).json({ message: 'Category deleted successfully', data: deletedCategory, status: 'success' })
        } catch (error: any) {
            return res.status(400).json({ error: error.message, status: 'failed' })
        }
    }
